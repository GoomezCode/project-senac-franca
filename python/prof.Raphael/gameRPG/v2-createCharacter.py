...
msg = f"""
------------- Status Personagem -------------
Nome: {statusPerson[0]["name"]}

forca: {statusPerson[1]["forca"]}
agilidade: {statusPerson[2]["agilidade"]}
inteligencia: {statusPerson[3]["inteligencia"]}
sorte: {statusPerson[4]["sorte"]}
class: {statusPerson[6]["class"]}

pontos: {statusPerson[7]["ponto"]}
------------- Status Personagem -------------
"""
